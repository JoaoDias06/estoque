...
<body class="grey lighten-3">
    <div>
        <h3 class="card-panel teal lighten-2 white-text align center">Adicionar Nova Marca</h3>

        <div class="row">
            <form action="insMarca.php" method="POST" class="col s12" id="frminsMarca">
                ...
                <div class="input-field col s8 offset-s2">
                    <label for="lblemail">Informe o Email de Contato da Marca</label>
