<?php 
    ...
    if ($busca != '')
        $sql = $sql . " WHERE NOME_CATEGORIA LIKE '%" . $busca . "%' ORDER BY NOME_CATEGORIA;";
...
<body class="grey lighten-5">
    <div class="container">
        ...
        <div class="input-field">
            <form action="listarCategorias.php" method="GET" id="frmbsccategoria" class="s12">
                    <label for="lblnome" class="teal-text">Informe o nome da Categoria</label>
                    <input type="text" placeholder="Informe o nome da Categoria a ser pesquisada" class="form-control s6" id="txtbusca" name="busca">
